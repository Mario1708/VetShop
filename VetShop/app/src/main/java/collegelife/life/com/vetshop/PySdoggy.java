...
public class PySdoggy extends ActionBarActivity {
    ListViewAdapter adaptadores;

    String[] titulos = new String[]{
            "Adiestramiento Basico",
            "Adiestramiento Semiprofesional",
            "Adiestramiento Profesional",
            "Adiestramiento Parvulos",
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_py_sdoggy);

        ListView lista = (ListView)findViewById(R.id.lvpysdoggy);
