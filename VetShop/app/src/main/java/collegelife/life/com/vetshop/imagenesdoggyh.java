...
public class imagenesdoggyh extends PagerAdapter {

    private int[] imagenesdoggyh= {R.drawable.ic_abanimal,R.drawable.ic_seprovet,R.drawable.ic_miperroenlaruch,R.mipmap.ic_googlemap};
    private Context contacto;
    private LayoutInflater layoutInflater;

    public imagenesdoggyh(Context contacto)
    {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        imageView.setImageResource(imagenesdoggyh[position]);
