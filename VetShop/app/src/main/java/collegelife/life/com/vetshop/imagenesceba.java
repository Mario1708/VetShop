...
public class imagenesceba extends PagerAdapter {

    private int[] imagenesceba = {R.drawable.ic_abanimal,R.drawable.ic_seprovet,R.drawable.ic_miperroenlaruch,R.mipmap.ic_googlemap};
    private Context contacto;
    private LayoutInflater layoutInflater;

    public imagenesceba(Context contacto)
    {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        imageView.setImageResource(imagenesceba[position]);
