...
public class PySpetsH extends ActionBarActivity {
    ...
    String[] subtitulos = new String[]{
            "La mejor forma de quemas energia",
            "Ideal para los gatos",
            "Estimulacion para todas las edades",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_py_spets_h);
        ListView lista = (ListView)findViewById(R.id.lvpysPetsHouse);
