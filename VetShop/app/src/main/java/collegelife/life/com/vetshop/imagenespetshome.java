...
public class imagenespetshome extends PagerAdapter {

    private int[] imagenpetshomes = {R.drawable.ic_atencionmedica,R.drawable.ic_laboratorio,R.mipmap.ic_colegio,R.mipmap.ic_googlemap};
    private Context contacto;
    private LayoutInflater layoutInflater;

    public imagenespetshome(Context contacto)
    {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        imageView.setImageResource(imagenpetshomes[position]);
