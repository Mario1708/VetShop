...
public class imagenescanitaxi extends PagerAdapter {

    private int[] imagenescanit = {R.drawable.ic_abanimal,R.drawable.ic_seprovet,R.drawable.ic_miperroenlaruch,R.mipmap.ic_googlemap};
    private Context contacto;
    private LayoutInflater layoutInflater;

    public imagenescanitaxi(Context contacto)
    {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        imageView.setImageResource(imagenescanit[position]);
