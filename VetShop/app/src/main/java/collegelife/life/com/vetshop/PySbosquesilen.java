...
public class PySbosquesilen extends ActionBarActivity {
    ...
    String[] subtitulos = new String[]{
            ...
            "Procedimientos patologicos existentes",
            "Limpieza, donductos y restauracion de sonrisa",
            "Manejo de procesos cardiacos, por y pre."
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_py_sbosquesilen);

        ListView lista = (ListView)findViewById(R.id.lvpysbosquesilen);
